                ...
                <form method="POST" action="{{ $url_form }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('nomor_rekening') is-invalid @enderror"
                            value="{{ isset($indikator_program) ? $indikator_program->nomor_rekening : old('nomor_rekening') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('nama_program') is-invalid @enderror"
                            value="{{ isset($indikator_program) ? $indikator_program->nama_program : old('nama_program') }}"
